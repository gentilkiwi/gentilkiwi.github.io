...
To debug/program, [Spy-Bi-Wire JTAG](https://www.ti.com/lit/pdf/slau320) is generally used, a 2-wire alternative transport for JTAG, multiplexing JTAG signals onto `TEST` and `RESET` pins, with a specific entry sequence.
...
#### Technically
> Your _not primary interest_ MCUs on the board dedicated to communication/trace are often more expensive than your main MCU
...
> Because I _needed_ such a tool, I implemented a client compatible with many adapters, and with my boards: <https://github.com/gentilkiwi/msp430_kibsl>
...
- <https://github.com/gentilkiwi/msp430_kibsl>